              ...
              tabBarIcon: ({ focused }) => (
                <Image
                  ...
                  style={{
                    width: 24,
                    height: 24,
                    tintColor: focused ? Colors.themeYellowColor : Colors.themeLightGrayTextColor,
                  }}
                />
              ),
            }}
              ...
              tabBarIcon: ({ focused }) => (
                <>
                  ...
                  <View
                    style={[
                      Style.searchTabBar,
                      { bottom: postTabBarHide ? (Platform.OS === 'ios' ? 0 : -25) : 10 },
                    ]}
                  >
                    <Image
                      ...
                      style={[
                        ...
                        {
                          tintColor: focused ? '' : Colors.themeLightGrayTextColor,
                        },
                      ]}
                    />
                  </View>
